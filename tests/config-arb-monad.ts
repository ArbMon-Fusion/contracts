...
export const config = {
    chain: {
        source: {
            ...
            limitOrderProtocol: '0xfde2d93A9D538940A9899CA6bEFa2517D9A0B23f', // Mock for now - will be updated
            ...
            tokens: {
                ETH: {
                    ...
                    donor: '0x0000000000000000000000000000000000000000'  // Not needed for native ETH
                },
                WETH: {
        ...
        destination: {
            ...
            tokens: {
                MON: {
                    ...
                    donor: '0x0000000000000000000000000000000000000000'  // Not needed for native MON
                },
                WMON: {
